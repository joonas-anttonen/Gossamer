namespace Gossamer.Utilities.ShaderCompiler;
...
class Program
{
    static int Main(string[] args)
    {
        ...
        {
            WriteLine("Usage: ShaderCompiler <input> <output>" +
                "\n" +
                "\n  <input>   Input .hlsl file or directory containing .hlsl files" +
                "\n  <output>  Output file" +
                "\n" +
                "\n  Example: ShaderCompiler shaders/ shaders.spv");
            return 1;
        }
    ...
    static IEnumerable<ShaderPipeline> CompileShaders(IEnumerable<ShaderDefinition> shaderDefinitions)
    {
        ...
        dxcProcess.StartInfo.FileName = "dxc.exe";
